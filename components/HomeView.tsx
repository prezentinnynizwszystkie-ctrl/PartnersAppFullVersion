...
import { Loader2, ArrowRight, BookOpen, Terminal } from 'lucide-react';
          ...
          <div className="space-y-8">
            ...
            <div>
                ...
                <Link
                    ...
                    className="group relative p-5 bg-slate-900 text-white border border-slate-800 rounded-2xl transition-all duration-300 hover:shadow-xl flex items-center justify-between hover:scale-[1.01]"
                >
                    <div className="flex items-center gap-5">
                        <div className="w-14 h-14 rounded-2xl flex items-center justify-center bg-white/10 border border-white/20 text-white">
                            <BookOpen size={24} />
                        </div>
                        <div>
                            <h3 className="text-lg font-bold">Podgląd Scenariusza</h3>
                            <p className="text-xs text-slate-400">Zobacz wygenerowany tekst bajki z placeholderami</p>
                        </div>
                    </div>
