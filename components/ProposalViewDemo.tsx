...
import { 
  ...
  CheckCircle2, DollarSign, ExternalLink, ChevronLeft,
...
const DEMO_PARTNER = {
    Id: 999,
    PartnerName: "JUMPCITY",
    Slug: "jumpcity",
    LogoUrl: "https://idbvgxjvitowbysvpjlk.supabase.co/storage/v1/object/public/PartnersApp/Partners/katowice/jumpcity/Logo_jumpcity.png", // Zaktualizowane logo
    PartnerType: "Park Trampolin",
    Status: "AKTYWNY",
    Model: "PROWIZJA",
    SellPrice: 149,
    Prowizja: 35,
    ...
    SprzedazWartosc: 0,
    IdOpiekuna: 999,
    Theme: { primaryColor: "#ff6600", accentColor: "#1f1f1f" } // Orange & Dark for Jumpcity vibe
};

const DEMO_SALESPERSON = {
    id: 999,
    imie: "Grzegorz",
    nazwisko: "Rabczak",
    email: "grzegorz@prezentinnynizwszystkie.pl",
    telefon: "501 031 430",
    photoUrl: "https://idbvgxjvitowbysvpjlk.supabase.co/storage/v1/object/public/PartnersApp/Handlowcy/Siwy1.webp"
};

const DEMO_AUDIO_URL = "https://idbvgxjvitowbysvpjlk.supabase.co/storage/v1/object/public/PartnersApp/Partners/katowice/jumpcity/MaliBohaterowie.MP3";

const ProposalViewDemo: React.FC = () => {
  // Audio Player State
  ...
  // Obliczenia zysków (logika z B2B Offer)
  ...
  const salesperson = DEMO_SALESPERSON;
    ...
    <div className="min-h-screen bg-[#FDFBF7] font-sans text-slate-900 selection:bg-blue-100 selection:text-blue-900 relative pt-16">
      ...
      <div className="fixed top-0 left-0 right-0 z-[100] bg-white border-b border-slate-200 px-6 py-3 flex justify-between items-center shadow-sm">
          <div className="flex items-center gap-2">
              <span className="bg-blue-600 text-white text-[10px] font-black uppercase px-2 py-1 rounded tracking-widest">DEMO</span>
              <span className="font-bold text-slate-900 text-sm">Podgląd Propozycji</span>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center h-full">
                ...
                >
                    <h1 className="text-4xl md:text-6xl font-display font-black leading-tight text-slate-900">
                        Cześć, <span style={{color: partner.Theme.primaryColor}}>Ekipo {partner.PartnerName}!</span>
                    </h1>
                    ...
                    {/* Salesperson Card (Przywrócona ramka "fajna") */}
                ...
                {/* Right: Salesperson Photo (Transparent, bez ramki z imieniem) */}
                <motion.div 
                ...
                >
                    ...
                    {/* Image - Używamy zdjęcia Siwego */}
                    <img 
                        src={salesperson.photoUrl}
                        alt={salesperson.imie} 
          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="relative w-full aspect-[21/9] bg-black rounded-[2rem] overflow-hidden shadow-2xl border-4 border-slate-700 group">
                  <video 
                      ...
                      poster="https://idbvgxjvitowbysvpjlk.supabase.co/storage/v1/object/public/PartnersApp/Partners/katowice/jumpcity/jumpcityposter.webp"
      ...
      <section className="py-20 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
              ...
              {/* 5. PROFIT CALCULATOR (Existing but restyled slightly) */}
      ...
      {/* 6. PSYCHOLOGY & AUDIO (Original Section) */}
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-2 md:order-1 relative">
                  ...
                  <div className="relative bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl border border-slate-100">
                      ...
                      {/* HARDCODED MP3 URL */}
                      <audio ref={audioRef} src={DEMO_AUDIO_URL} onEnded={() => setIsPlayingAudio(false)} className="hidden" />
                  </div>
              </div>
